...
! function(t, e) {
    ...
    function i(i, s) {
        function o() {
            d.width = i.offsetWidth, d.height = i.offsetHeight, h.fillStyle = s.dotColor, h.strokeStyle = s.lineColor, h.lineWidth = s.lineWidth
        }
        ...
        function l() {
            switch (this.stackPos, this.active = !0, this.layer = Math.ceil(3 * Math.random()), this.parallaxOffsetX = 0, this.parallaxOffsetY = 0, this.position = {
                x: Math.ceil(Math.random() * d.width),
                y: Math.ceil(Math.random() * d.height)
        ...
        var d, h, f, c, u, m, x = !!e.createElement("canvas").getContext,
            y = [],
            g = 0,
            v = 0,
            w = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i),
            S = !!t.DeviceOrientationEvent,
            X = 0,
            Y = 0,
            M = !1;
        return s = function(t) {
                ...
                return t
            }({}, t[a].defaults, s), l.prototype.draw = function() {
                h.beginPath(), h.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, s.particleRadius / 2, 0, 2 * Math.PI, !0), h.closePath(), h.fill(), h.beginPath();
                for (var t = y.length - 1; t > this.stackPos; t--) {
                    var e = y[t],
                        i = this.position.x - e.position.x,
                        a = this.position.y - e.position.y;
                    Math.sqrt(i * i + a * a).toFixed(2) < s.proximity && (h.moveTo(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY), s.curvedLines ? h.quadraticCurveTo(Math.max(e.position.x, e.position.x), Math.min(e.position.y, e.position.y), e.position.x + e.parallaxOffsetX, e.position.y + e.parallaxOffsetY) : h.lineTo(e.position.x + e.parallaxOffsetX, e.position.y + e.parallaxOffsetY))
                }
                h.stroke(), h.closePath()
            }, l.prototype.updatePosition = function() {
                if (s.parallax) {
                    if (S && !w) u = (X - -30) * ((f - 0) / 60) + 0, m = (Y - -30) * ((c - 0) / 60) + 0;
                    else u = g, m = v;
                    this.parallaxTargX = (u - f / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10, this.parallaxTargY = (m - c / 2) / (s.parallaxMultiplier * this.layer), this.parallaxOffsetY += (this.parallaxTargY - this.parallaxOffsetY) / 10
                }
                var t = i.offsetWidth,
                    e = i.offsetHeight;
                switch (s.directionX) {
            ...
            }, l.prototype.setStackPos = function(t) {
                this.stackPos = t
            },
            function() {
                if (x) {
                    (d = e.createElement("canvas")).className = "pg-canvas", d.style.display = "block", i.insertBefore(d, i.firstChild), h = d.getContext("2d"), o();
                    ...
                    t.addEventListener("resize", (function() {
                        ! function() {
                            o();
                            for (var t = i.offsetWidth, e = i.offsetHeight, a = y.length - 1; a >= 0; a--)(y[a].position.x > t || y[a].position.y > e) && y.splice(a, 1);
                        ...
                        g = t.pageX, v = t.pageY
                    }), !1), S && !w && t.addEventListener("deviceorientation", (function() {
                ...
                destroy: function() {
                    console.log("destroy"), d.parentNode.removeChild(d), p("onDestroy"), n && n(i).removeData("plugin_" + a)
                },
                start: function() {
                    M = !1, r()
                },
